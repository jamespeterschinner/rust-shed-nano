...
use crate::lighting::{LightingAction, LightingController};
...
const DESIRED_HZ_TIM1: f64 = 12.0; // Period of 83 milli seconds
...
// Input debounce
const INPUT_BUFFER_SIZE: usize = 6;
...
static mut LIGHTING_CONTROLLER: LightingController = LightingController::new(4);
...
pub unsafe extern "avr-interrupt" fn __vector_11() {
    ...
    without_interrupts(|| {
        ...
        match LIGHTING_CONTROLLER.clock() {
    ...
    without_interrupts(|| {
        ...
        if inputs & !buffered_values > 0 {
            ...
            if light_toggle_input(inputs) {
                match LIGHTING_CONTROLLER.toggle() {
